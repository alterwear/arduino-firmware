...
#define IMAGE_1  stars1
#define IMAGE_2  stars2
#define IMAGE_3  stars3
#define IMAGE_4  stars12
#define IMAGE_5  stars13
#define IMAGE_6  stars23
#define IMAGE_7  star123
...
#define IMAGE_6_FILE MAKE_JOIN(IMAGE_6,EPD_IMAGE_FILE_SUFFIX)
#define IMAGE_6_BITS MAKE_NAME(IMAGE_6,EPD_IMAGE_NAME_SUFFIX)
#define IMAGE_7_FILE MAKE_JOIN(IMAGE_7,EPD_IMAGE_FILE_SUFFIX)
#define IMAGE_7_BITS MAKE_NAME(IMAGE_7,EPD_IMAGE_NAME_SUFFIX)
...
#error "unsupported image function"
    ...
    case 6:        // picture -> text
#if EPD_IMAGE_ONE_ARG
    EPD.image(IMAGE_6_BITS);
#elif EPD_IMAGE_TWO_ARG
    EPD.image(IMAGE_5_BITS, IMAGE_6_BITS);
#else
#error "unsupported image function"
#endif
    ++state;  // back to picture next time
    break;
     ...
     case 7:        // picture -> text
#if EPD_IMAGE_ONE_ARG
    EPD.image(IMAGE_7_BITS);
#elif EPD_IMAGE_TWO_ARG
    EPD.image(IMAGE_6_BITS, IMAGE_7_BITS);
#else
#error "unsupported image function"
#endif
