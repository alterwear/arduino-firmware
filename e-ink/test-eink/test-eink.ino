...
#define IMAGE_2 trip_middle
#define IMAGE_3 trip_end
...
void loop() {
  ...
  case 0:         // clear the screen
    Serial.println("case 0: clear screen");
    EPD.clear();
    state = 1;
  ...
  case 1:         // trip start
    Serial.println("case 1: trip start");
...
#error "unsupported image function"
  ...
  case 2:         // trip middle
    Serial.println("case 1: trip middle");
#if EPD_IMAGE_ONE_ARG
...
#error "unsupported image function"
  ...
  case 3:        // trip end
    Serial.println("case 1: trip end");
#if EPD_IMAGE_ONE_ARG
...
#error "unsupported image function"
#endif
    state = 3;  // back to picture next time
    break;
  }
